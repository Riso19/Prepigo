                  ...
                  <TooltipProvider>
                    ...
                    <BrowserRouter>
                      <Routes>
                        ...
                        />
                        <Route
                          path="/question-bank/:bankId/edit/:mcqId"
                          element={<EditMcqPage />}
                        />
                        <Route
                          path="/question-bank/:bankId/practice"
                          element={<PracticeMcqPage />}
                        />
                        ...
                        <Route
                          path="/mcq-practice/setup"
                          element={<CustomMcqPracticeSetupPage />}
                        />
